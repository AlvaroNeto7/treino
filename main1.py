...
root = Tk()
root.title("Calculadora Alvaro Neto")
root.geometry("570x800+100+200")
...
def show(value):
    global equantion
    equantion+=value
    label_result.config(text=equantion)
...
Button(root,text="C", width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#44ff00",command=lambda: clear()).place(x=10,y=100)
...
Button(root,text=".", width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#2a2d36",command=lambda: show(".")).place(x=168,y=500)
